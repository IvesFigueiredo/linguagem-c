...
Assunto: Questão 02 - Lista 04, Programa para receber dois parâmetros (Peso e Altura) e calcular o peso ideal.*/
...
system("cls");
        ...
        printf("Deseja realizar um outro processo? [ s - Sim | n - Não ]\n");
        scanf(" %c", &retorno);
