...
//Adicionado por Ives Figueiredo a opção do recepcionista por o cliente recém cadastrado na fila (Diretamente) - ln 229 - 254
*/
        ...
        case 1:
            do
            {
                ...
                case 2:
                    ...
                    system("cls");
                    printf("\033[1;30mDeseja ingressar na fila de atendimento? [ Sim | Não ]\033[0m \n");
                    scanf("%s", filacadastro);

                    if (strcmp(filacadastro, "sim") == 0)
                    {
                        if (contador == T_FILA)
                        {
                            system("cls");
